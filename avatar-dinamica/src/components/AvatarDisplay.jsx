  ...
  const gerarRelatorio = async () => {
    ...
    if (error) {
      ...
      const vencedoresArray = Object.keys(contagemVencedores).map((nome) => ({
        ...
        total: Object.values(contagemVencedores[nome]).reduce(
          (sum, count) => sum + count,
          0
        ),
      }));
    ...
    >
      ...
      {avatarNome && (
        ...
        >
          ...
          <Typography
            variant="h5"
            sx={{ fontWeight: "bold", color: "#f1f1f1" }}
          >
          ...
          return (
            <Box
              ...
              sx={{
                ...
                borderLeft:
                  index !== 0 ? "2px solid rgba(255, 255, 255, 0.3)" : "none",
              }}
            >
              <Typography
                variant="h4"
            ...
            <Table>
              ...
              <TableBody>
                {relatorio.map((champion, index) => (
                  <TableRow key={index} sx={{ marginLeft: "50px" }}>
